...
class LoginPage(Frame):
    def __init__(self, window):
        ...
        self.lb_login_page = Label(self, text='User login page', font='arial', fg='pink', bg='maroon')
        self.lb_user = Label(self, text='Username', font='arial', bg='maroon')
        self.lb_pass = Label(self, text='Password', font='arial', bg='maroon')
        ...
        self.lb_status = Label(self, text='', bg='maroon', font='arial')
...
class RegisterPage(Frame):
    def __init__(self, window):
        ...
        self.lb_fname = Label(self, text='First Name', bg='orange', font='arial')
        self.lb_lname = Label(self, text='Last Name', bg='orange', font='arial')
        self.lb_number = Label(self, text='Mobile number', bg='orange', font='arial')
        self.lb_email = Label(self, text='Email id', bg='orange', font='arial')
        self.lb_new_password = Label(self, text='New Password', bg='orange', font='arial')
        self.lb_confirm_new = Label(self, text='Confirm Password', bg='orange', font='arial')
        ...
        self.lb_status = Label(self, text='', bg='orange', font='arial')
...
class DashboardPage(Frame):
    def __init__(self, window):
        ...
        # label
        self.lb_dashboard = Label(self, text='Dash Board', bg='yellow', font='arial')
...
class DepartmentPage(Frame):
    def __init__(self, window):
        ...
        self.upper_frame = Frame(self, bg='dark green')
        self.upper_frame = Frame(self, bg='dark green')
        self.lower_frame = Frame(self, width=400, height=304, bg='orange')
        ...
        # Labels
        self.lb_depart_id = Label(self.upper_frame, text='Department Id', bg='pink', font='arial')
        self.lb_depart_name = Label(self.upper_frame, text='Department Name', bg='pink', font='arial')
        ...
        self.lb_status = Label(self.upper_frame, text='', bg='pink', font='arial')
        self.lb_status.grid(row=4, column=0)
...
class EmployeePage(Frame):
    def __init__(self, window):
        ...
        self.upper_frame = Frame(self, bg='grey')
        self.lower_frame = Frame(self, width=670, height=245, bg='grey')
        self.lower_frame.pack_propagate(0)

        self.upper_frame.pack(side=TOP)
        self.lower_frame.pack(side=BOTTOM)

        self.lb_id = Label(self.upper_frame, text='Id', bg='orange', font='arial')
        self.lb_fname = Label(self.upper_frame, text='First Name', bg='orange', font='arial')
        self.lb_lname = Label(self.upper_frame, text='Last Name', bg='orange', font='arial')
        self.lb_age = Label(self.upper_frame, text='Age', bg='orange', font='arial')
        self.lb_number = Label(self.upper_frame, text='Mobile number', bg='orange', font='arial')
        self.lb_address = Label(self.upper_frame, text='Address', bg='orange', font='arial')
        ...
        self.lb_choose_depart = Label(self.upper_frame, text='Choose department', bg='dark green', font='arial')
